...
public partial class MasterPage_mehman : System.Web.UI.MasterPage
{
    ...
    {
        //تعداد بازدید ها
      //  Label1.Text = Application["activeuser"].ToString();
 ...
 if (int.Parse(Class1.Count_login_rpt()) >= 200)
        {

            c1.CmdSqlDataBaesAccess("Delete From rpt_log");
        c1.CmdSqlDataBaesAccess("insert into rpt_log(us,date_login,ip_login,contry,city)values('Guest','" + DateTime.Now.ToLongTimeString()+" | "+Class1.GetClockShamsi() + "','" + Class1.GetUsersIP() + "','','')");
