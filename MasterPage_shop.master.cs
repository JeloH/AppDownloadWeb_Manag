...
public partial class MasterPage_mehman : System.Web.UI.MasterPage
{
 ...
 if (int.Parse(Class1.Count_login_rpt()) >= 200)
        ...
        c1.CmdSqlDataBaesAccess("insert into rpt_log(us,date_login,ip_login,contry,city)values('مهمان','" + DateTime.Now.ToLongTimeString()+" | "+Class1.GetClockShamsi() + "','" + Class1.GetUsersIP() + "','','')");
