 ...
 seo = keyWords;
     ...
     //   lng_file=  Class1.GetLengthFile(url_soft_Address);//size file soft
      ...
      if (lng_file != "")
        ...
        //c1.CmdSqlDataBaesAccess("insert into demah.send_softwear(date,title,img_address,soft_address,body,Abstruct,type,lenght,source_company,subject_post,password_softwear,seo)values('" + Class1.GetClockShamsi() + "',N'" + TextBox2.Text + "',N'" + TextBox7.Text + "',N'" + TextBox8.Text + "',N'" + FCKeditor1.Value + "',N'" + TextBox4.Text + "',N'" + DropDownSelect + "' ,N'" + TextBox15.Text + "' ,N'" + TextBox6.Text + "',N'" + subject_post + "' ,N'" + TextBox_Password.Text + "' ,N'" + TextBox16.Text + "' )");

        c1.CmdSqlDataBaesAccess("insert into demah.send_softwear(date,title,img_address,soft_address,body,Abstruct,type,lenght,source_company,subject_post,password_softwear,seo)values('" + Class1.GetClockShamsi() + "',N'" + TextBox2.Text + "',N'" + TextBox7.Text + "',N'" + TextBox8.Text + "',N'" + TextBox4.Text + "',N'" + TextBox4.Text + "',N'" + DropDownSelect + "' ,N'" + TextBox15.Text + "' ,N'" + TextBox6.Text + "',N'" + subject_post + "' ,N'" + TextBox_Password.Text + "' ,N'" + TextBox16.Text + "' )");
