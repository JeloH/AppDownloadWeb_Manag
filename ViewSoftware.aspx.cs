...
public partial class ViewSoftware : System.Web.UI.Page
{

    Class1 c1 = new Class1();


 static string code_post = "0";
...
ViewSoftware.code_post = Page.Request.QueryString["page"].ToString();


 key_url = Page.Request.Url.ToString();
   

if(ViewSoftware.code_post == Page.Request.QueryString["page"].ToString())
{
...
Class1.url_Address = Page.Request.Url.ToString();
 ...
 string str3 = "";
        ...
        SqlCommand cmd = new SqlCommand("demah.StoredProcedure_View", con);
        SqlDataReader r;
        ...
        SqlParameter param;
         ...
         param.Value = ViewSoftware.code_post;
              ...
              Page.Title = r["title"].ToString();
                    ...
                    lenght.Text = r["lenght"].ToString();
                     ...
                     v1 = v1 + 1;
                       ...
                       c1.CmdSqlDataBaesAccess("update demah.send_softwear set View_Count= '" + v1 + "' where code_post='" + ViewSoftware.code_post + "' ");
...
//                keyWords =" ";
            ...
            if (div1.Visible == true)
            {
             ...
             //   TextBox1_type.Text = r["type"].ToString();
                ...
                TextBox1_SubjectPost.Text = r["subject_post"].ToString();
 ...
 insert_comment();
  ...
  protected void LinkButton1_Click1(object sender, EventArgs e)
    ...
    public void insert_comment() {
       ...
       int cp=int.Parse(ViewSoftware.code_post);
     ...
     cmd.Parameters.Add("@type_post", SqlDbType.NVarChar).Value = ViewSoftware.type_post;
