...
Default7.code_post = Page.Request.QueryString["page"].ToString();


 key_url = Page.Request.Url.ToString();
   

if(Default7.code_post == Page.Request.QueryString["page"].ToString())
{
...
Class1.url_Address = Page.Request.Url.ToString();
 ...
 string str3 = "";
        ...
        SqlParameter param;
         ...
         param.Value = Default7.code_post;
       ...
       // cmd.Parameters.Add(param);
        ...
        while (r.Read())
        {
              ...
              HyperLink31.Text = r["title"].ToString();
                    ...
                    Image1.ImageUrl = r["address_pic"].ToString(); ;

                    bodyLabel.Text = r["matn"].ToString();
            ...
            //  typeLabel.Text = r["type"].ToString();
                   ...
                   //    c1.CmdSqlDataBaesAccess("update demah.send_softwear set View_Count= '" + v1 + "' where code_post='" + Default7.code_post + "' ");
                    ...
                    subject_post.Text = r["title"].ToString();
...
//                keyWords =" ";
            ...
            if (div1.Visible == true)
            {
                ...
                Image2.ImageUrl = r["address_pic"].ToString(); 

                 FCKeditor1.Value = r["matn"].ToString();
             //   TextBox1_type.Text = r["type"].ToString();

                 //DropDownList1.SelectedValue =r["type"].ToString();
                ...
                //TextBox1_DateSend.Text = r["date"].ToString();

                TextBox1_SubjectPost.Text = r["title"].ToString();
                TextBox1_Seo.Text = r["seo"].ToString();

                //TextBox1_SourceOrCompany.Text = r["source_company"].ToString();

               TextBox1_AddressIMG.Text = r["address_pic"].ToString(); 
            ...
            typeLabel.Text = "--" + r.Read().ToString() + "--" + r.FieldCount.ToString();
...
Class1.url_Address = Class1.url_Address.Split('&')[0];//جلوگیری از تکرار چاپ کلمات کلیدی
 ...
 string s9= Page.Request.Url.ToString();
    ...
    public void View_comment_Enable()
    {
        ...
        string query = "SELECT name, code, body, date,pasokh FROM comments WHERE  code_post = @code_post and status=@status";
        ...
        sql_da.SelectCommand.Parameters.AddWithValue("@type_post", "0");
 ...
 insert_comment();
  ...
  protected void LinkButton1_Click1(object sender, EventArgs e)
    ...
    public void insert_comment() {
       ...
       int cp=int.Parse(Default7.code_post);
     ...
     cmd.Parameters.Add("@type_post", SqlDbType.NVarChar).Value = Default7.type_post;
